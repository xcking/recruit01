...
<div id="tit">
	...
	<tbody>
		...
		<tr class="trClass" style="height:45px;">
			...
			<td name="status">
				<a href="application_UpdateHire?hire='已被招聘' " class="a1" >确认招聘</a>&nbsp;
				<a href="application_UpdateHire?hire='条件不匹配' "  class="a1_yellow" >条件不匹配</a>&nbsp;
				<a href="application_UpdateHire?hire='移交给用人部门等待稍后联系' "  class="a1_violet" >移交给用人部门等待稍后联系</a>&nbsp;
			</td>
		</tr>
		</c:forEach>
		<tr class="trClass" style="height:45px;">
